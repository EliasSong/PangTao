...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(PangTao::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(PangTao::Address::ptr address);
...
//     static SSLSocket::ptr CreateTCP(PangTao::Address::ptr address);
